 ...
 */
final class Version20241013123545 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE apropos (id INT NOT NULL, id_association_id INT NOT NULL, mots VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_2440FEAAD2DF75A3 ON apropos (id_association_id)');
        ...
        $this->addSql('ALTER TABLE apropos ADD CONSTRAINT FK_2440FEAAD2DF75A3 FOREIGN KEY (id_association_id) REFERENCES association (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE apropos DROP CONSTRAINT FK_2440FEAAD2DF75A3');
